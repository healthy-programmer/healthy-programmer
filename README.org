...
2. Open Terminal and run:
   #+BEGIN_SRC shell
   ./script/run_move_reminder_mac.sh --interval 60 --duration 30 --position bottom-right
   #+END_SRC
   This script will:
...
2. Open Command Prompt and run:
   #+BEGIN_SRC bat
   script\run_move_reminder.bat --interval 60 --duration 30 --position bottom-right
   #+END_SRC
